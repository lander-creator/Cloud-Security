...
//-------------------------------------------------------------------------------
//                         MQTT ID & TOPIC
#define MQTT_SERIAL_PUBLISH_CH "Lander/measurement"
const char *TOPIC1 = "Lander/button";  // Topic to subcribe to
#define MQTT_SERIAL_RECEIVER_CH "Lander/led"
const String DEVICE_ID = "Lander";
//-------------------------------------------------------------------------------
//                            broker IP
...
void loop() {
   ...
   if (digitalRead(button) == LOW){
      ...
      Serial.println((String)TOPIC1 + " => btn");
   }
   else {
    char* message = "0";
    delay(2000);
